...
func (_m *SensorRepositoryInterface) Create(ctx context.Context, w *domain.SensorRequest) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *domain.SensorRequest) error); ok {
		r0 = rf(ctx, w)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *SensorRepositoryInterface) GetAll(ctx context.Context, page int, limit int) ([]domain.Sensor, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int) ([]domain.Sensor, error)); ok {
		return rf(ctx, page, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int) []domain.Sensor); ok {
...
func (_m *SensorRepositoryInterface) GetByID(ctx context.Context, id string) (*domain.Sensor, error) {
	...
	var r0 *domain.Sensor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*domain.Sensor, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *domain.Sensor); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.Sensor)
...
func (_m *SensorRepositoryInterface) Update(ctx context.Context, w *domain.Sensor) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *domain.Sensor) error); ok {
		r0 = rf(ctx, w)
	} else {
		r0 = ret.Error(0)
	}
...
// NewSensorRepositoryInterface creates a new instance of SensorRepositoryInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSensorRepositoryInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *SensorRepositoryInterface {
	mock := &SensorRepositoryInterface{}
	mock.Mock.Test(t)
